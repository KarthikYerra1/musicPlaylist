...
class App extends Component {
  ...
  onClickedDelete = id => {
    ...
    const updatedTrackList = trackList.filter(each => each.id !== id)
  ...
  render() {
    ...
    return (
      <>
        <AppContainerUpper>
          <UpperHeading>Ed Sheeran</UpperHeading>
          <UpperDescription as="p">Singer</UpperDescription>
        </AppContainerUpper>
        <AppContainerLower>
          <LowerSearchContainer>
            <LowerHeading>Songs Playlist</LowerHeading>
            <SearchContainer>
              <InputElement
                value={searchInput}
                placeholder="Search"
